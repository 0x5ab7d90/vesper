...
export const PALETTE: Record<DitherColor, Seed> = {
  ...
  // Added for Vesper: the drop mascot's purple (--color-mascot), so charts and washes sit
  // in the app's one chromatic colour rather than the kit's cooler purple.
  violet: { fill: [122, 63, 228], line: [190, 160, 255], star: [220, 205, 255] },
