...
// Central Icons "camera-sparkle" — line, 2px, round joins, large corner radius.
export const CameraSparkleIcon = (props: IconProps): React.JSX.Element => (
  <svg {...base} {...props}>
    <path
      d="M21 13V17C21 18.6569 19.6569 20 18 20H6C4.34315 20 3 18.6569 3 17V9.93125C3 8.31236 4.31236 7 5.93125 7C6.91132 7 7.82654 6.51019 8.37019 5.69472L8.6094 5.3359C9.1658 4.5013 10.1025 4 11.1056 4H12"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
// Central Icons "checkmark-1", same family as the camera above.
export const CheckmarkIcon = (props: IconProps): React.JSX.Element => (
  <svg {...base} {...props}>
    <path
